...
import { validateEditScope, analyzeFileScope, ScopeValidationError } from '../src/planner/scopeValidator.js';
...
export { example1_analyzeScope, example2_validationPasses, example3_validationFails, example4_declaredGlobals };
