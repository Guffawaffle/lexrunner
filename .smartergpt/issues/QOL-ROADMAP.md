...
**Wave 2: Make it professional** (5-6h total)
3. QOL-004: CLI integration
4. QOL-005: Schema versioning

**Wave 3: Make it maintainable** (4-7h total)
5. QOL-006: Debug mode
6. QOL-002: Retention policy
