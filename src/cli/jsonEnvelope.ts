 ...
 */
export function createErrorEnvelope(command: string, error: JsonError): JsonErrorEnvelope {
  return {
    success: false,
    error,
    meta: createMeta(command),
 ...
 * @param data - Command-specific payload
 */
export function writeSuccessEnvelope<T = unknown>(command: string, data: T): void {
 ...
 */
export function writeErrorEnvelope(command: string, error: JsonError): void {
 ...
 */
export function errorToJsonError(error: unknown, code: string = "EUNKNOWN"): JsonError {
