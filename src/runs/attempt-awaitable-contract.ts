...
import type { JsonValue } from "../store/coordination-store.js";
...
function inspectJson(value: unknown): {
  ...
  return { valid, depth: maximumDepth, entries, ...(authorityField ? { authorityField } : {}) };
}
