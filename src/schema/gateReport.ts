 ...
 */
export const GateReportSchemaVersion = z
  .string()
  .regex(/^1\.\d+\.\d+$/)
  .default("1.0.0");
 ...
 */
export function safeValidateGateReport(
  data: unknown
): { success: true; data: GateReport } | { success: false; error: z.ZodError } {
