...
export type Severity = "blocker" | "must-fix" | "should-fix" | "nit" | "praise" | "review";
...
export type ExecutorMode = "triage" | "deep_review" | "pattern_mining" | "mentorship";
...
export const EXECUTOR_MODES: Record<ExecutorMode, ModeConfig> = {
  triage: {
    ...
    prerequisites: ["prepare-review-context.sh", "recall-context.sh (optional)"],
