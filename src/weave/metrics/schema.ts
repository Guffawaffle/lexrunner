 ...
 */
export function getInterventionsByLevel(level: DeterminismLevel): InterventionDefinition[] {
...
export function createAuditEntryWithTokens(
  base: Omit<z.infer<typeof InterventionAuditEntry>, "token_usage" | "task_id" | "snapshot_hash">,
