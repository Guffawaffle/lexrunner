...
import type { TestFixPattern, TriggerMatch, FixLocation } from "./schema.js";
 ...
 */
export function matchTriggers(testOutput: string, patterns: TestFixPattern[]): TriggerMatch[] {
 ...
 */
export function findFixLocations(workspaceRoot: string, pattern: TestFixPattern): FixLocation[] {
...
export function matchAndLocate(
  ...
  const results = new Map<string, { trigger: TriggerMatch; locations: FixLocation[] }>();
