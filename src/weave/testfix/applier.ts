 ...
 * @returns Fix result
 */
export function applyFix(instruction: FixInstruction, dryRun: boolean = false): FixResult {
 ...
 */
export function applyFixes(instructions: FixInstruction[], dryRun: boolean = false): FixResult[] {
