...
export type EnhancedAdminAuthorityConfig = z.infer<typeof EnhancedAdminAuthorityConfig>;
 ...
 */
export function parseEnhancedAdminAuthority(data: unknown): EnhancedAdminAuthorityConfig {
...
export function createDefaultAdminAuthorityConfig(): EnhancedAdminAuthorityConfig {
  return {
    ...
    conditions: [
      ...
      {
        type: "label",
        labels_absent: ["do-not-merge", "wip", "blocked", "needs-discussion"],
      },
      {
        type: "ci_status",
