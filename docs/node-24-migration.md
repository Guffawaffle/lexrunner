...
LexRunner 1.2.1 established the Ecosystem 3.1 Node.js 24 floor, and LexRunner 1.4.0 preserves it.
...
Push-Location $smoke
npm init -y
npm install @smartergpt/lexrunner@1.4.0
npx lex-pr --help
...
CLI result, MCP `tools/list` result, and timestamp in the release evidence tracked by issue #909.
