...
describe("Dependency Scoring", () => {
  ...
  describe("Empty Inputs", () => {
    ...
    it("should handle PRs with no body", async () => {
      const prs = [{ number: 101, name: "PR-101", body: null, sha: "abc123" }];
  ...
  describe("Integration Scenarios", () => {
    it("should correctly rank mix of explicit and file-overlap suggestions", async () => {
      ...
      const sharedFilesScore = scores.find((s) => s.reason === "shared-files");
      const dirProxScore = scores.find((s) => s.reason === "directory-proximity");
