...
describe("Security - Secrets Management", () => {
  ...
  describe("Secrets Manager", () => {
    ...
    it("should require secret and throw if missing", async () => {
      await expect(secretsManager.requireSecret("REQUIRED_SECRET")).rejects.toThrow(
    ...
    it("should validate required secrets", async () => {
      ...
      const result = await secretsManager.validateSecrets(["SECRET1", "SECRET2", "MISSING"]);
    ...
    it("should validate all secrets present", async () => {
      ...
      const result = await secretsManager.validateSecrets(["SECRET1", "SECRET2"]);
