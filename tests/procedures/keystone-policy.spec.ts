  ...
  describe("Schema Validation", () => {
    it("validates a complete keystone policy", () => {
      const policy = {
        ...
        whenToUse: ["True cross-cutting concerns", "Hot-path fixes"],
        whenNotToUse: ["Single-PR issues", "Issues that could be done before/after wave"],
        risks: ["Bottleneck creep", "Less parallelism"],
