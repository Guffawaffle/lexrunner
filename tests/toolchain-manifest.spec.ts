...
import { generateToolchainManifest, formatToolchainAsMarkdown } from "../src/orchestration/toolchainManifest";
...
describe("Toolchain Manifest", () => {
	...
	describe("formatToolchainAsMarkdown", () => {
		...
		it("should be valid markdown", () => {
			...
			expect(markdown.split("\n").filter(line => line.includes("|")).length).toBeGreaterThanOrEqual(3);
		});
