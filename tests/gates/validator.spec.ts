...
describe("Gate Input Validation", () => {
  ...
  describe("test gate", () => {
    ...
    it("fails on missing required fields", () => {
      ...
      expect(() => validateGateInput("test", input)).toThrow(/required property 'files'/i);
    });
  ...
  describe("build gate", () => {
    ...
    it("fails on missing command", () => {
      ...
      expect(() => validateGateInput("build", input)).toThrow(/required property 'command'/i);
    });
