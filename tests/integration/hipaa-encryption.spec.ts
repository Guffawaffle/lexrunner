...
// Use the tracked .smartergpt/ example profile (not .smartergpt.local/ which doesn't exist in CI)
const EXAMPLE_PROFILE = path.join(ROOT, ".smartergpt");
...
describe("HIPAA encryption finalize (integration)", () => {
	test("with valid 64-hex key produces .enc and removes plaintext", () => {
		...
		env.LEX_AUDIT_KEY_HEX =
			"0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef";
		// Point to example profile so CLI can resolve profile in CI
		env.LEX_PR_PROFILE_DIR = EXAMPLE_PROFILE;
