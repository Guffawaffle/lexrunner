...
describe('Run Manager', () => {
	...
	describe('startRun', () => {
		...
		it('should set progress with procedure-specific steps', () => {
			const input: StartRunInput = {
				mode: 'senior-dev',
				procedure: 'merge-weave-main',
				repo: 'owner/repo'
			...
			expect(result.initialStatus.progress?.current).toBe('fetch-prs');
			expect(result.initialStatus.progress?.remaining).toContain('analyze-deps');
		});
	});
