...
describe("Metrics Schema", () => {
  ...
  describe("INTERVENTION_CATALOG", () => {
    ...
    it("has correct distribution of levels", () => {
      const d1 = INTERVENTION_CATALOG.filter((i) => i.determinism_level === "D1");
      const d2 = INTERVENTION_CATALOG.filter((i) => i.determinism_level === "D2");
      const d3 = INTERVENTION_CATALOG.filter((i) => i.determinism_level === "D3");
  ...
  describe("getInterventionsByLevel", () => {
    it("returns D1 interventions", () => {
      ...
      expect(result.every((i) => i.determinism_level === "D1")).toBe(true);
    });
  ...
  describe("createAuditEntryWithTokens", () => {
    ...
    it("includes task_id and snapshot_hash when provided", () => {
      ...
      const tokenUsage = computeTokenUsage(1000, 500, 300);
      const result = createAuditEntryWithTokens(base, tokenUsage, "task-123", "abc123def456");
