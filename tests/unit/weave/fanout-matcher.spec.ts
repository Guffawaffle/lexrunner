...
import type { FanoutTemplate, FanoutTemplates } from "../../../src/weave/fanout/schema.js";
...
`;
  ...
  describe("matchesFilePatterns", () => {
    it("matches exact patterns", () => {
      expect(matchesFilePatterns("src/test.ts", ["src/test.ts"])).toBe(true);
    });
    ...
    it("rejects non-matching patterns", () => {
      ...
      expect(matchesFilePatterns("src/test.ts", ["other/**"])).toBe(false);
    });

    it("matches any pattern in array", () => {
      expect(matchesFilePatterns("src/test.ts", ["**/*.js", "**/*.ts"])).toBe(true);
    });
  });

  describe("matchTemplateAgainstFile", () => {
    const createTemplate = (overrides: Partial<FanoutTemplate> = {}): FanoutTemplate => ({
      id: "test",
      trigger: {
