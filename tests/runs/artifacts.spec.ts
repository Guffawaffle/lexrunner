...
describe("Artifact Discovery", () => {
  ...
  describe("matchesPattern", () => {
    ...
    it("should handle complex patterns", () => {
      expect(matchesPattern("gates/lint/npm-lint/report.json", "gates/*/npm-*/report.json")).toBe(
        true
      );
      expect(matchesPattern("gates/test/npm-test/report.json", "gates/*/npm-*/report.json")).toBe(
        true
      );
      expect(matchesPattern("gates/lint/jest/report.json", "gates/*/npm-*/report.json")).toBe(
        false
      );
    });
  });
