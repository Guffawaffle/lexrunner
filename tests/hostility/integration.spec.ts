...
import { runEnvironmentQualityCheck, formatHostilityReport } from "../../src/hostility/index.js";
...
describe("Hostility Integration", () => {
  ...
  describe("runEnvironmentQualityCheck", () => {
    ...
    it("returns low hostility for well-configured environment", () => {
      ...
      fs.writeFileSync(path.join(tempDir, ".smartergpt", "intent.md"), "# Intent");
      fs.writeFileSync(path.join(tempDir, ".smartergpt", "gates.yml"), "gates:\n  - name: lint");
