...
describe("Environment Utils", () => {
  ...
  describe("validateCIEnvironment", () => {
    ...
    it("should require GITHUB_TOKEN for CI role", () => {
      ...
      expect(() => validateCIEnvironment(profile)).toThrow("CI environment validation failed");
      expect(consoleErrorSpy).toHaveBeenCalledWith("❌ CI environment validation failed:");
      expect(consoleErrorSpy).toHaveBeenCalledWith(expect.stringContaining("Missing GITHUB_TOKEN"));
    });
