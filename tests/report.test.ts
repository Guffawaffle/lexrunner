...
describe("Report Aggregator", () => {
  ...
  it("reads single gate report correctly", () => {
    ...
    fs.writeFileSync(path.join(tempDir, "test-report.json"), JSON.stringify(reportData));
  ...
  it("aggregates multiple reports with stable ordering", () => {
    ...
    reports.forEach((report, index) => {
      fs.writeFileSync(path.join(tempDir, `report-${index}.json`), JSON.stringify(report));
    });
  ...
  it("handles validation errors in gate reports", () => {
    ...
    fs.writeFileSync(path.join(tempDir, "invalid-report.json"), JSON.stringify(invalidReport));
  ...
  it("handles JSON parse errors", () => {
    ...
    fs.writeFileSync(path.join(tempDir, "malformed.json"), "{ invalid json");
