...
describe("ActionReceipt Schema", () => {
  ...
  describe("ReversibilityLevel", () => {
    it("should accept valid reversibility levels", () => {
      ...
      expect(ReversibilityLevel.parse("partially-reversible")).toBe("partially-reversible");
      expect(ReversibilityLevel.parse("irreversible")).toBe("irreversible");
    });
  ...
  describe("ActionReceiptSchema", () => {
    ...
    it("should validate optional fields", () => {
      ...
      expect(result.escalationReason).toBe("Complex conflict requires human review");
    });
  });
  ...
  describe("UncertaintyMarkerSchema", () => {
    it("should validate a complete UncertaintyMarker", () => {
      ...
      expect(result.operation).toBe("merge PR-456 with active dependencies");
